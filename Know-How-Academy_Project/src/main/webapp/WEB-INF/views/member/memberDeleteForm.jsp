...
<body>
   ...
   <form id="memberDelete-form" action="/know-how/myPage/memberDeleteForm/delete" method="post">
        ...
        <br>
          <h2 align="center" class="memberDeletePage-title">회원탈퇴 유의사항</h2>
        <br>
      ...
      <table class="memberDeletePage-table" >
       <thead>
        ...
        <tr>
             <th>
               <h4><label class="Deletelabel">사용중인 아이디는 탈퇴 시, 본인과 타인 모두 재사용및 복구할 수 없으니, 신중히 선택해 주세요.</label></h4>
             </th>
        </tr>
        <tr>
       ...
       <tbody>
        ...
        <tr>
           ...
           <th><button type="submit" class="btn-memberDeletePage">
                  동의하고 탈퇴하기</button></th>
