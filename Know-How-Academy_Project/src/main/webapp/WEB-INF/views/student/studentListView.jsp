	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<body>
			...
			<div class="outer">
				...
				<div class="write-btn-area" align="right">
					<a href="/know-how/board/enrollForm" type="button" class="btn btn-outline-secondary">글쓰기</a>
				</div>
									...
									<c:choose>
										<%--검색어 미입력 조회 일경우--%>
											...
											<%--검색어 입력 조회 일경우--%>
												<c:otherwise>
													<li class="page-item">
														<a class="page-link" href="/know-how/board/search?cpage=
														${requestScope.pi.currentPage - 1}
								...
								<c:otherwise>
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item">
												<a class="page-link"
													href="/know-how/board/search?condition1=${condition1}&condition2=${condition2}&keyword=${keyword}&cpage=${p}">${p}</a>
											</li>
										</c:otherwise>
									</c:choose>
								</c:otherwise>
									...
									<c:choose>
										<%--검색어 미입력 조회 일경우--%>
											<c:when test="${empty keyword}">
												<li class="page-item">
													<a class="page-link"
														href="/know-how/board/list?cpage=${pi.currentPage + 1}">></a>
												</li>
											</c:when>
											<%--검색어 입력 조회 일경우--%>
												<c:otherwise>
