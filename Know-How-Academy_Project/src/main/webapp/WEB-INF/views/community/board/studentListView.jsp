			...
			<div class="outer">
				...
				<div id="search-area">
					...
					<div id="search-container">
						...
						<select name="condition2" id="categoryDrop" class="form-control mr-sm-2"
							onchange="drawBoard(1);">
					...
					<script>
						(function () {
							...
							if (condition1 && condition1.trim() != "") {
								$("#commonDrop").val(condition1).prop("selected", true);
							}
							if (condition2 && condition2.trim() != "") {
								$("#categoryDrop").val(condition2).prop("selected", true);
							}
						})();
					</script>
				</div>
				...
				<script>
					...
					function drawBoard(cpage) {
						...
						//조건검색과 입력된 검색어 가져오기
						let condition1 = $("#commonDrop").val();
						let condition2 = $("#categoryDrop").val();
					...
					function renderBoard(boardList) {
						...
						if (currentView === "list") {
							...
							for (var i = 0; i < boardList.length; i++) {
								...
								if (b.category === 'admission') {
									category = '입학상담';

								} else if (b.category === 'employment') {
									category = '취업상담';
								}
							...
							for (var i = 0; i < boardList.length; i++) {
								...
								html += '<div class="card-body">' +
									'<h5 class="card-title-custom elipsis-cell" >' +
									'<span class="badge bg-secondary me-2" style="text-align: left; !importent">' +
									category +
									'</span>' +
									b.title +
									'</h5>' +
