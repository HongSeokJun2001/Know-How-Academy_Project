									...
									<c:choose>
										<%--검색어 미입력 조회 일경우--%>
											<c:when test="${empty keyword}">
												<li class="page-item">
													<a class="page-link"
														href="/know-how/community/board/post?cpage=${requestScope.pi.currentPage - 1}">
														Prev</a>
												</li>
											</c:when>
											<%--검색어 입력 조회 일경우--%>
								...
								<c:otherwise>
									<c:choose>
										<c:when test="${ empty keyword}">
											<li class="page-item">
												<a class="page-link"
													href="/know-how/community/board/post?cpage=${p}">${p}</a>
											</li>
										</c:when>
										<c:otherwise>
											<li class="page-item">
									...
									<c:choose>
										<%--검색어 미입력 조회 일경우--%>
											<c:when test="${empty keyword}">
												<li class="page-item">
													<a class="page-link"
														href="/know-how/community/board/post?cpage=${pi.currentPage + 1}">Next</a>
												</li>
											</c:when>
											<%--검색어 입력 조회 일경우--%>
												<c:otherwise>
